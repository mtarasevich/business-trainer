...
## Revision-1 QA (27-Apr-26)
Точечные правки клиента, smoke-test пройден:
- HTTP 200 на `/index.html` и `/assets/styles.css` ✓
- Слово «коуч/коучинг» в HTML — 0 вхождений ✓
- «Индивидуальные сессии / сессию» — 5 вхождений (hero, navigation CTA, услуга, форма, ссылка) ✓
- Новый текст кейса 1 («Оптовой компании необходимо…») присутствует ✓
- Класс `msg-btn--tg` и `msg-btn--viber` присутствуют в HTML и CSS ✓
- Inline SVG-иконки Telegram (бумажный самолётик) и Viber (телефон) встроены, размер 22×22 в круге 44×44 ✓
- aria-label для кнопок мессенджеров заданы ✓
- На мобильной ширине кнопки переносятся под телефон (media-query 900px) ✓

Регрессий не обнаружено: остальные секции, Lightbox, форма, навигация — не затронуты, файлы стилей/JS остались с прежними хешами. Полный регресс не требуется (минимальные изменения).

---

## Полный отчёт первого QA-прохода
